...
- **Data-export & print** (PLT-4) — boodschappenlijst/saldo als CSV of deelbare tekst. *(Zie ook de
  ...
  > PLT-5, PLT-7, PLT-8, PLT-3 en DOC-1 zijn **gepromoot naar §6** — daarom hier weggehaald,
  > conform de §7-regel "verdwijnt hier".
