...
| INF-11 | Platform | Mutatie-baseline voor 5 nieuwe modules | Next | Could | S | ✅ | — | **Opgelost en gecommit:** de 5 modules staan in `mutation-baseline.json` op HEAD (baseline-totaal inmiddels 5214 mutanten / 83.1%); CI-mutatierun groen (geverifieerd 2026-06-27). [plan 18](docs/plans/18-ux-verbeterplan.md). |
