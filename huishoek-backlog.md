...
- **Veilige onderrand overal** (UX-5) — tabbalk, toast én elke onderaan-ingeschoven sheet/modal
  vallen op Android (app + mobiel web) onder de systeem-navigatieknoppen: edge-to-edge zonder
  window-insets. Consequente fix via `useSafeAreaInsets()`. **Deels gedaan:** de gedeelde
  `BottomSheet` (`lib/ui.js`) lost de sheets/modals op (o.a. Dagboekfoto, recept kiezen); tabbalk +
  toast-offset resteren. Raakt elk scherm. Zie §6.
