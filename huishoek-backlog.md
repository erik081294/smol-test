...
|----|--------|---------|------|------|-------|--------|------|---------|
| ARCH-1 | Fundament | Gedeelde entity-editor (formValidation + useEntityForm) | Now | Should | M | ◐ | — | **Fundament gebouwd** (architectuur-review 2026-06-26): pure [`lib/formValidation.js`](lib/formValidation.js) (ratchet 92,1%) + dunne [`lib/useEntityForm.js`](lib/useEntityForm.js); `visibilityRule` in [`lib/visibility.js`](lib/visibility.js). [`app/expense/[id].js`](app/expense/[id].js) omgezet als referentie. **🔧 Smoke-test open** (device-batch §C in [`VERIFICATIE.md`](VERIFICATIE.md)): gedragsneutrale conversie, nog niet op toestel/web bevestigd. **Rest:** plant/pet/vehicle/task incrementeel migreren, nieuwe editors volledig (values+errors). Contract: [`docs/architectuur.md`](docs/architectuur.md). |
