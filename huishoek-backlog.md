...
| PLT-1 | Platform | Notificaties & herinneringen | 2 | Should | M | ✅ | — | **Plan 05 — gebouwd; migratie `0018` (`push_tokens`) live (2026-06-20)**. Trap 1 lokaal (`expo-notifications`, `useNotifications`, prefs-scherm) werkt. Units `lib/notifications.js` uitgebreid. **Rest (trap 2 remote):** Edge Function `notify` deployen + toestel-push-test. |
