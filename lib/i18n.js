...
const DICT = {
  nl: {
    ...
    'appearance.soon': 'Donkere modus wordt binnenkort actief — je keuze wordt alvast bewaard.',
    ...
    // te vullen.
    'catalog.open': 'Producten zoeken',
    'catalog.title': 'Producten',
    'catalog.search': 'Zoek een product…',
    'catalog.all': 'Alles',
    'catalog.add': "'{name}' toevoegen",
    'catalog.added': "'{name}' op de lijst",
    'catalog.start.title': 'Zoek of kies een categorie',
    'catalog.start.subtitle': 'Typ hierboven, of tik een schap om producten te zien.',
    'catalog.empty.title': 'Niets gevonden',
    'catalog.empty.subtitle': 'Probeer een andere zoekterm of categorie.',
    'catalog.error.add': 'Kon niet toevoegen',
    'catalog.attribution': 'Productdata: Open Food Facts',
    ...
    'recurring.perPerson': '{amount} per persoon',
    'recurring.delete': 'Terugkerende uitgave verwijderen',
    'recurring.delete.confirm': 'Deze terugkerende uitgave verwijderen?',
