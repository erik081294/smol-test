...
const spanStyle = (s) => [
  s.bold ? { fontFamily: font.semi } : null,
...
// Tik = inspecteren (selectie in forestPressed, het pressed-token), nogmaals = weg.
                ...
                >
                  ...
                  <View
                    style={{
                      alignSelf: 'stretch',
                      height: barHeight,
                      backgroundColor: bar.value > 0 ? (isSelected ? colors.forestPressed : colors.forest) : colors.lineStrong,
                  ...
                  <React.Fragment key={i}>
                    ...
                    <View
                      ...
                      style={{
                        ...
                        backgroundColor: isSelected ? colors.forestPressed : colors.forest,
                      }}
                    />
                  </React.Fragment>
                );
    ...
    <Card raised={false} style={{ backgroundColor: colors.surface }}>
      <Stack gap={space.sm}>
        ...
        {node.options.map((opt, i) => (
          ...
          >
            <T variant="body" style={{ fontFamily: font.semi }}>{opt.label}</T>
