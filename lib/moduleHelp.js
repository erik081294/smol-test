...
export const moduleHelp = {
  ...
  assistent: {
    title: 'Assistent',
    intro: 'Een behulpzame huisgenoot: stel een vraag over jullie huishouden in gewone taal.',
    points: [
      'Vraag bijvoorbeeld wat er vandaag op de planning staat, of wat er bijna op is.',
      'De assistent ziet alleen wat jij zelf mag zien, en je gesprekken zijn privé.',
      'De assistent doet nooit iets zonder dat jij het eerst bevestigt.',
    ],
  },
};
