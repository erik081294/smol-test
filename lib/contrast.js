...
// Kies uit twee kandidaat-voorgronden (donker/licht) degene met het hoogste
// contrast op achtergrond `bg`. Voor tekst/iconen op een dynamische kleur die niet
// vooraf bekend is — bv. de actieve chip op een categoriekleur of de FAB op het
// accent. Zo wordt de voorgrond op RUNTIME gekozen i.p.v. een vaste (vaak te lage)
// kleur. Bij gelijkspel wint `dark`. Puur; default zwart/wit.
export function pickReadable(bg, dark = '#000000', light = '#ffffff') {
