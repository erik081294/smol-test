...
const darkColors = {
  bg:         '#13120E',  // warm bijna-zwart
  surface:    '#1E1C16',  // kaarten/rijen — net iets lichter dan bg
  surfaceAlt: '#2A271F',  // zachte vulling, ingedrukte staat
  overlay:    'rgba(0,0,0,0.6)',

  forest:     '#2F7058',  // diepgroen, lichter zodat knop/accent oplicht op donker
  forestSoft: '#3E8E6F',
  forestTint: '#1E2A24',  // donkergroene vlek (badges, selectie)
