...
export function selectNewDeltas(filenames = [], watermark = 0) {
  ...
  // Gat: we hebben eerder gesynct (watermark>0) maar de oudste delta begint ná ons
  // watermerk → er zit een niet-gedekt gat tussen (volle her-import nodig).
  const oldestFrom = parsed.length ? parsed[0].from : 0;
