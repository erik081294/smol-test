...
// -> { [profileId]: cents }
//
// Contract: amountCents is een geheel aantal HELE CENTEN ≥ 0 (de invoerpaden borgen
// dit — parseAmountToCents weigert negatief; er is geen refund/krediet-feature). De
// som-invariant `som(aandelen) === amountCents` geldt sowieso, óók bij een negatief
// totaal (de restcent-lus + tie-break blijven deterministisch). Wil je ooit negatieve
// bedragen (terugboeking) ondersteunen, herzie dan eerst de restcent-verdeling bewust.
