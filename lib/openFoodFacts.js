...
const FIELDS = 'code,product_name,product_name_nl,brands,quantity,image_url,image_front_url';
...
export function parseOffProduct(json, code) {
  ...
  return {
    ...
    category: 'overig', // OFF-categorieën mappen we (nog) niet; gebruiker herclassificeert
