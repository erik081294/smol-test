...
export function ItemRow({
  leading, title, titleColor, strikethrough, meta, trailing,
...
export function Checkbox({ checked, onPress, color = colors.forest, size = 26, shape = 'square', accessibilityLabel }) {
  return (
    ...
    >
      {checked ? <Icon name="check" size={size * 0.72} color={colors.onDark} weight="bold" /> : null}
    </Pressable>
  );
}
...
// ===========================================================================
export function Empty({ icon, emoji, title, subtitle, actionTitle, onAction }) {
  return (
