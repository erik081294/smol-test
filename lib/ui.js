...
import { Text, TextInput, Pressable, View, ActivityIndicator, ScrollView, Animated, Platform, KeyboardAvoidingView } from 'react-native';
...
export function Editor({
  ...
  children, scrollRef, contentContainerStyle,
}) {
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
        <ModalHeader
          title={title} onClose={onClose} onConfirm={onConfirm} busy={busy}
