...
function TimelineFeed({ size, style, details }) {
  ...
  return (
    <WidgetTile moduleKey="tijdlijn" style={style} size={size} showDetails={details} icon="feed" title={t('home.card.timeline.title')}
...
const WIDGET_DEFS = [
  ...
  { key: 'activiteit.feed', module: 'tijdlijn', title: t('home.card.timeline.title'), icon: 'feed', sizes: SIZES, defaultSize: '2x1', isDefault: true, Render: TimelineFeed },
];
