      ...
      {order.map((key) => {
        ...
        return (
          <DragCell
            ...
            onDragEnd={onDragEnd}
          >
            <View pointerEvents={editing ? 'none' : 'auto'} style={{ height: tileH }}>
...
function DragCell({ cellKey, rect, cellH, editing, reduce, shared, onDragStart, onDragMove, onDragEnd, children }) {
