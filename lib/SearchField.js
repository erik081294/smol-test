...
// `autoFocus` opent het toetsenbord meteen — voor schermen waar zoeken dé actie is
// (bv. het globale zoekscherm), niet voor lijsten waar de zoekbalk bijzaak is.
export function SearchField({ value, onChangeText, label, style, autoFocus = false }) {
  return (
    <View style={[{
      ...
      <TextInput
        ...
        autoCorrect={false} returnKeyType="search" accessibilityLabel={label} autoFocus={autoFocus}
        style={{
