...
export function applyTaskFilters(tasks, { categories = [], assignees = [], subgroupId = null, status = 'open' } = {}) {
...
export function activeFilterCount({ categories = [], assignees = [], subgroupId = null, status = 'open' } = {}) {
  let n = 0;
