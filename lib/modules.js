...
export const MODULES = [
  ...
  { key: 'voertuigen', label: 'Voertuigen', emoji: '🚗', icon: 'voertuig', route: 'voertuigen', kind: 'data', table: 'vehicles', creatorColumn: 'created_by', core: false, primary: false, group: 'huis' },
  { key: 'tijdlijn', label: 'Tijdlijn', emoji: '📌', icon: 'pinboard', route: 'tijdlijn', kind: 'data', table: 'timeline_posts', creatorColumn: 'author_id', core: false, primary: false, group: 'huis' },
  { key: 'maaltijden', label: 'Keuken', emoji: '🍳', icon: 'meals', route: 'maaltijden', kind: 'data', table: 'meal_plan_entries', creatorColumn: 'created_by', core: false, primary: false, group: 'eten' },
