...
// elke ingeschakelde module. Daarom is het de enige primaire "overzicht"-tab en
// staat Agenda niet meer als eigen tab-icoon — die is bereikbaar via een Home-kaart
// en via "Meer". Zo blijft de tabbalk kort (Thuis · Taken · Boodschappen · Meer).
export const MODULES = [
  { key: 'vandaag', label: 'Thuis', emoji: '🏡', icon: 'home', route: 'vandaag', kind: 'overview', table: null, core: true, primary: true },
  ...
  { key: 'agenda', label: 'Agenda', emoji: '📅', icon: 'agenda', route: 'agenda', kind: 'overview', table: null, core: false, primary: false },
  ...
  { key: 'maaltijden', label: 'Maaltijden', emoji: '🍳', icon: 'meals', route: 'maaltijden', kind: 'data', table: 'meal_plan_entries', creatorColumn: 'created_by', core: false, primary: false },
  { key: 'voorraad', label: 'Voorraad', emoji: '🥫', icon: 'pantry', route: 'voorraad', kind: 'data', table: 'pantry_items', creatorColumn: 'updated_by', core: false, primary: false },
  { key: 'delen', label: 'Delen', emoji: '🤝', icon: 'share', route: 'delen', kind: 'data', table: 'shared_resources', creatorColumn: 'created_by', core: false, primary: false },
  { key: 'huishouden', label: 'Huishouden', emoji: '🏡', icon: 'group', route: 'huishouden', kind: 'admin', table: null, core: true, primary: false },
];
