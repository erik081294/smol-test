...
export function AuthProvider({ children }) {
  ...
  const value = {
    ...
    // Leeg de in-memory data-cache zodat data van deze gebruiker niet blijft hangen
    // voor een volgende login op hetzelfde toestel (PERF-2 cache-hygiëne).
    signOut: () => { clearCache(); return supabase.auth.signOut(); },
