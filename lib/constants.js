...
export const CATEGORIES = ['klus', 'huishouden', 'plant', 'huisdier', 'afspraak', 'overig', 'voertuig'];
...
// Kleurenpalet voor zelfgemaakte tags (UX-41). Vaste hexes (geen thema-token): een tag
// draagt z'n eigen kleur, gelijk in licht/donker. Distinct genoeg om uit elkaar te houden.
export const TAG_COLORS = ['#E4572E', '#F3A712', '#2E933C', '#3A7CA5', '#7B4BC4', '#C2417B', '#5A6470'];

// Store-listings (PLT-7). Eén plek voor de download-links op het join-succes-scherm
// (app/join/[token].js). Zolang beide null zijn toont dat scherm een rustige,
// niet-tikbare "binnenkort in de stores"-caption i.p.v. badges — nooit een dode link.
// TODO(Erik): vul hier de echte URL's in zodra de App Store-/Google Play-listings
// live zijn; de tikbare store-badges verschijnen dan vanzelf.
export const STORE_LINKS = {
  ios: null, // bv. 'https://apps.apple.com/app/id…'
  android: null, // bv. 'https://play.google.com/store/apps/details?id=…'
};
