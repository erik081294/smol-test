  ...
  const load = useCallback(async () => {
    ...
    const data = await run(
      supabase
        ...
        // PERF-1: ruime veiligheidsdrempel op de voltooiingen-log. 2000 voltooiingen
        // is in de praktijk "alles" (jaren huishouden), maar begrenst de worst-case.
        // Exacte all-time-totalen bij overschrijding horen later naar een server-side
        // aggregaat-RPC (zie backlog PERF-1).
        .limit(2000),
