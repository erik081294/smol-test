...
import {
  ...
  ArrowsOutLineHorizontal, ArrowsInLineHorizontal,
  CookingPot, Jar, Palette, ClockCounterClockwise, FunnelSimple,
  // personen / toewijzing
  User,
  // huisdieren (HUI-1)
  PawPrint, Scales, Cake, Stethoscope, IdentificationCard,
  // status
  Info, Warning,
  // lege staten
