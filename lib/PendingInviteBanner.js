  ...
  return (
    <View style={[{ backgroundColor: colors.forest, borderRadius: radius.md, padding: space.lg, marginBottom: space.lg }, style]}>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: space.sm }}>
        ...
        <Text style={{ color: colors.onDark, fontFamily: font.semi, marginLeft: space.sm, fontSize: 15 }}>
          {t('invite.banner.title')}
        </Text>
      </View>
      <Text style={{ color: colors.onDark, marginBottom: space.md, lineHeight: 20 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: space.sm }}>
        ...
        <Pressable onPress={clearPendingInvite} accessibilityRole="button"
          ...
          <Text style={{ color: colors.onDark, fontFamily: font.semi }}>{t('invite.banner.dismiss')}</Text>
        </Pressable>
      </View>
    </View>
  );
