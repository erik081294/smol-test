...
export function ChoreLibrarySheet({ visible, onClose, onAdd }) {
  ...
  const monthName = format(new Date(), 'MMMM', { locale: nl });
    ...
    <Modal visible={visible} animationType="slide" transparent onRequestClose={close}>
      <View style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: colors.overlay }}>
        <View style={{
          ...
          paddingHorizontal: space.lg, paddingTop: space.lg, paddingBottom: space.xl, maxHeight: '85%',
        }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: space.xs }}>
            ...
            <Pressable onPress={close} hitSlop={10} accessibilityRole="button" accessibilityLabel="Sluiten">
